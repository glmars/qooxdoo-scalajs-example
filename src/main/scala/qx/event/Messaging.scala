...
class Messaging extends js.Object {
    protected def _addListener(channel: String, typ: String, handler: js.Function, scope: js.Any = ???): String = js.native
    ...
    def on(channel: String, typ: String, handler: js.Function, scope: js.Any = ???): String = js.native
    def onAny(typ: String, handler: js.Function, scope: js.Any = ???): String = js.native
