...
class Spinner protected () extends qx.ui.core.Widget with qx.ui.form.INumberForm with qx.ui.form.IRange with qx.ui.form.IForm with qx.ui.core.MContentPadding with qx.ui.form.MForm {
    ...
    protected def _onChangeLocale(ev: qx.event.typ.Event): Unit = js.native
    protected def _onChangeNumberFormat(ev: qx.event.typ.Event): Unit = js.native
    ...
    protected def _onTextChange(e: qx.event.typ.Event): Unit = js.native
