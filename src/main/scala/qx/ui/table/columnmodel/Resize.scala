...
class Resize extends qx.ui.table.columnmodel.Basic with qx.locale.MTranslation {
    protected def _addResetColumnWidthButton(event: qx.event.typ.Data): Unit = js.native
    ...
    protected def _onappear(event: qx.event.typ.Event): Unit = js.native
    protected def _oncolumnwidthchanged(event: qx.event.typ.Data): Unit = js.native
    protected def _onTableWidthChanged(event: qx.event.typ.Event): Unit = js.native
    protected def _onverticalscrollbarchanged(event: qx.event.typ.Data): Unit = js.native
    protected def _onvisibilitychanged(event: qx.event.typ.Data): Unit = js.native
