...
object Element extends js.Object {
    ...
    def addListener(element: HTMLElement, typ: String, listener: js.Function, self: js.Any = ???, capture: Boolean = ???): String = js.native
    ...
    def hasListener(element: HTMLElement, typ: String, capture: Boolean = ???): Boolean = js.native
    def releaseCapture(element: HTMLElement): Unit = js.native
    def removeListener(element: HTMLElement, typ: String, listener: js.Function, self: js.Any = ???, capture: Boolean = ???): Boolean = js.native
